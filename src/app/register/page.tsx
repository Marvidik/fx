        ...
        <div className={styles.authCard}>
          ...
          <div className={styles.authContentNew}>
            ...
            <form className={styles.authForm} onSubmit={handleSubmit}>
              <div className={styles.formGrid}>
                <div className={styles.formGroup}>
                  ...
                  <div className={styles.inputWrapper}>
                    ...
                    <input type="text" name="full_name" value={formData.full_name} onChange={handleChange} placeholder={t.enterFullName} required />
                  </div>
                </div>
                <div className={styles.formGroup}>
                  ...
                  <div className={styles.inputWrapper}>
                    <span style={{ color: '#94a3b8' }}><UserIcon /></span>
                    <input type="text" name="username" value={formData.username} onChange={handleChange} placeholder={t.chooseUsername} required />
                  </div>
                </div>
              </div>
              ...
              <div className={styles.formGrid} style={{ marginTop: '20px' }}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <div className={styles.inputWrapper}>
                    <span style={{ color: '#94a3b8' }}><MailIcon /></span>
                    <input type="email" name="confirmEmail" value={formData.confirmEmail} onChange={handleChange} placeholder={t.confirmEmailPlaceholder} required />
                  </div>
                </div>
              </div>
              ...
              <div className={styles.formGroup} style={{ marginTop: '20px' }}>
                ...
                <div className={styles.inputWrapper}>
                  ...
                  <input type="text" name="address" value={formData.address} onChange={handleChange} placeholder={t.enterAddress} required />
                </div>
              </div>
              ...
              <div style={{ marginTop: '30px', background: '#f8fafc', padding: '15px', borderRadius: '10px' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer', fontSize: '0.95rem' }}>
                  ...
                  <span>{t.agreeWith} <span style={{ color: '#127a6f', fontWeight: 700 }}>{t.termsConditions}</span></span>
                </label>
              </div>
            ...
            <div style={{ textAlign: 'center', marginTop: '30px', color: '#64748b' }}>
              {t.alreadyHaveAccount} <Link href="/login" style={{ color: '#127a6f', fontWeight: 700 }}>{t.signInTitle}</Link>
            </div>
          </div>
        </div>
      </div>
